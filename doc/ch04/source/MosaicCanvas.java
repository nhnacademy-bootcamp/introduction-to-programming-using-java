...
public class MosaicCanvas extends Canvas {
    ...
    /**
     * Construct a MosaicCanvas with specified numbers of rows and columns of
     * rectangles,
     * and with preferred rectangle height and width both set to 16.
     */
     ...
     * to the panel, and its width is taken into account in the computation of the
     * preferred
     * size of the panel.
     *
     ...
     *                             rectangles. This must be a positive number.
     * @param preferredBlockWidth  the preferred width of the mosaic will be set to
     *                             this value times the number of
     *                             columns. The actual width is set by the component
     *                             that contains the mosaic, and so might not be
     *                             equal to the preferred width. Size is measured in
     *                             pixels. The value should not be less than about
     *                             5,
     *                             and any smaller value will be increased to 5.
     * @param preferredBlockHeight the preferred height of the mosaic will be set to
     *                             this value times the number of
     *                             rows. The actual height is set by the component
     *                             that contains the mosaic, and so might not be
     *                             equal to the preferred height. Size is measured
     *                             in pixels. The value should not be less than
     *                             about 5,
     *                             and any smaller value will be increased to 5.
     */
     ...
     * true.
     * <p>
     * Note that clearing or filling the mosaic will cause an immediate
